...
public class RespawnPacket implements MinecraftPacket {
  ...
  public static RespawnPacket fromJoinGame(JoinGamePacket joinGamePacket) {
    return new RespawnPacket(joinGamePacket.getDimension(), joinGamePacket.getPartialHashedSeed(),
        joinGamePacket.getDifficulty(), joinGamePacket.getGamemode(), joinGamePacket.getLevelType(),
        (byte) 0, joinGamePacket.getDimensionInfo(), joinGamePacket.getPreviousGamemode(),
        joinGamePacket.getCurrentDimensionData(), joinGamePacket.getLastDeathPosition(), joinGamePacket.getPortalCooldown());
  }
