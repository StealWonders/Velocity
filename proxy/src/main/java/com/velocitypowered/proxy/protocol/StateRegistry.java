...
public enum StateRegistry {
  ...
  STATUS {
    {
      serverbound.register(
          StatusRequestPacket.class, () -> StatusRequestPacket.INSTANCE, map(0x00, MINECRAFT_1_7_2, false));
      serverbound.register(StatusPingPacket.class, StatusPingPacket::new, map(0x01, MINECRAFT_1_7_2, false));

      clientbound.register(
          StatusResponsePacket.class, StatusResponsePacket::new, map(0x00, MINECRAFT_1_7_2, false));
      clientbound.register(StatusPingPacket.class, StatusPingPacket::new, map(0x01, MINECRAFT_1_7_2, false));
    }
  },
  CONFIG {
    {
      serverbound.register(
          ClientSettingsPacket.class, ClientSettingsPacket::new, map(0x00, MINECRAFT_1_20_2, false));
      serverbound.register(
          PluginMessagePacket.class, PluginMessagePacket::new, map(0x01, MINECRAFT_1_20_2, false));
      serverbound.register(
          FinishedUpdatePacket.class, FinishedUpdatePacket::new, map(0x02, MINECRAFT_1_20_2, false));
      serverbound.register(KeepAlivePacket.class, KeepAlivePacket::new, map(0x03, MINECRAFT_1_20_2, false));
      serverbound.register(
          PingIdentifyPacket.class, PingIdentifyPacket::new, map(0x04, MINECRAFT_1_20_2, false));
      serverbound.register(
      ...
      clientbound.register(
          PluginMessagePacket.class, PluginMessagePacket::new, map(0x00, MINECRAFT_1_20_2, false));
      clientbound.register(
          DisconnectPacket.class, () -> new DisconnectPacket(false), map(0x01, MINECRAFT_1_20_2, false));
      clientbound.register(
          FinishedUpdatePacket.class, FinishedUpdatePacket::new, map(0x02, MINECRAFT_1_20_2, false));
      clientbound.register(KeepAlivePacket.class, KeepAlivePacket::new, map(0x03, MINECRAFT_1_20_2, false));
      clientbound.register(
          PingIdentifyPacket.class, PingIdentifyPacket::new, map(0x04, MINECRAFT_1_20_2, false));
      clientbound.register(
          RegistrySyncPacket.class, RegistrySyncPacket::new, map(0x05, MINECRAFT_1_20_2, false));
      clientbound.register(
          RemoveResourcePackPacket.class, RemoveResourcePackPacket::new, map(0x06, MINECRAFT_1_20_3, false));
  ...
  PLAY {
    {
      ...
      serverbound.register(
          FinishedUpdatePacket.class, FinishedUpdatePacket::new, map(0x0B, MINECRAFT_1_20_2, false));
  ...
  LOGIN {
    {
      serverbound.register(ServerLoginPacket.class, ServerLoginPacket::new, map(0x00, MINECRAFT_1_7_2, false));
      serverbound.register(
          EncryptionResponsePacket.class, EncryptionResponsePacket::new, map(0x01, MINECRAFT_1_7_2, false));
      serverbound.register(
          LoginPluginResponsePacket.class, LoginPluginResponsePacket::new, map(0x02, MINECRAFT_1_13, false));
      serverbound.register(
          LoginAcknowledgedPacket.class, LoginAcknowledgedPacket::new, map(0x03, MINECRAFT_1_20_2, false));

      clientbound.register(
          DisconnectPacket.class, () -> new DisconnectPacket(true), map(0x00, MINECRAFT_1_7_2, false));
      clientbound.register(
          EncryptionRequestPacket.class, EncryptionRequestPacket::new, map(0x01, MINECRAFT_1_7_2, false));
      clientbound.register(
          ServerLoginSuccessPacket.class, ServerLoginSuccessPacket::new, map(0x02, MINECRAFT_1_7_2, false));
      clientbound.register(
          SetCompressionPacket.class, SetCompressionPacket::new, map(0x03, MINECRAFT_1_8, false));
      clientbound.register(
          LoginPluginMessagePacket.class, LoginPluginMessagePacket::new, map(0x04, MINECRAFT_1_13, false));
    }
  };
