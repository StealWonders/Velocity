...
public class KeyedVelocityTabList implements InternalTabList {
  ...
  public void clearAll() {
    ...
    clearAllSilent();
    connection.delayedWrite(new LegacyPlayerListItemPacket(LegacyPlayerListItemPacket.REMOVE_PLAYER, items));
  }
  ...
  void updateEntry(int action, TabListEntry entry) {
    if (entries.containsKey(entry.getProfile().getId())) {
      ...
      connection.write(new LegacyPlayerListItemPacket(action, Collections.singletonList(packetItem)));
    }
  }
}
